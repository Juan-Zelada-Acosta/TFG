...
@section('contenido')
    <div class="container py-5">
        ...
        <div class="d-flex justify-content-center gap-3 mb-4">
            <a href="index.php?accion=calcetines" class="btn {{ empty($coleccionActiva) ? 'btn-primary' : 'btn-outline-primary' }}">Todas</a>
            <a href="index.php?accion=calcetines&coleccion=nueva" class="btn {{ $coleccionActiva === 'nueva' ? 'btn-primary' : 'btn-outline-primary' }}">Nueva Colección</a>
            <a href="index.php?accion=calcetines&coleccion=rebajas" class="btn {{ $coleccionActiva === 'rebajas' ? 'btn-primary' : 'btn-outline-primary' }}">Rebajas</a>
            <a href="index.php?accion=calcetines&coleccion=estándar" class="btn {{ $coleccionActiva === 'estándar' ? 'btn-primary' : 'btn-outline-primary' }}">Colección Estándar</a>
        </div>
