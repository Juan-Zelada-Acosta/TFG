    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <p class="fw-bold text-blue fs-5">{{ number_format($producto['precio'], 2) }}€</p>
                ...
                <form id="formCarrito">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="talla" id="talla" class="form-select" required>
                            ...
                            @if ($disponible > 0)
                            <option value="{{ $talla }}">{{ $talla }} ({{ $disponible }} disponibles)</option>
                            @else
                            <option value="" disabled>{{ $talla }} (agotado)</option>
                            @endif
                            @endforeach
                        </select>
                    </div>
